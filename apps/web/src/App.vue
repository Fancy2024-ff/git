        ...
        onMessage: (msg) => {
          ...
          if (msg.type === 'step_finished') {
            ...
            if (idx >= 0) {
              ...
              livePipelineSteps.value[idx].duration_ms = msg.duration_ms
              livePipelineSteps.value[idx].finished_at = msg.finished_at
  ...
  <div class="app" :class="{ 'app--dimmed': menuOpen }">
    ...
    <main class="main" @click="menuOpen = false">
      ...
      <div class="panel-area">
        ...
        <StepsPanel v-if="activeTab === 'steps'" />
