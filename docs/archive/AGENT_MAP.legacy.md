...
> 🗄️ **历史文档，不代表当前架构和当前入口。**
> 本文描述的是 `scripts/run_demo_pipeline.py` + `agents/*` 时代的结构，均已删除。
> 当前权威的步骤/能力图见 **`docs/architecture/AGENT_MAP.md`**，
> 当前入口见 **`docs/operation/RUNBOOK.md`** 与 **`docs/CODE_STRUCTURE.md`**。
